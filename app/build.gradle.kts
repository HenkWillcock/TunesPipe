...
android {
    namespace = "com.tunespipe.music"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.tunespipe.music"
        minSdk = 26
        targetSdk = 36
        versionCode = 128
        versionName = "12.7.0"
    ...
    buildTypes {
        release {
            ...
            // --- START OF THE FIX ---
            // For local builds, sign the release variant with the debug key.
            // The CI/CD server for official builds will override this.
