...
import com.tunespipe.music.constants.HistorySource
...
import com.tunespipe.music.viewmodels.DateAgo
import com.tunespipe.music.viewmodels.HistoryViewModel
...
fun HistoryScreen(
    ...
    Box(Modifier.fillMaxSize()) {
        LazyColumn(
            ...
            item(key = "chips_row") {
                ChipsRow(
                    chips = listOf(HistorySource.LOCAL to stringResource(R.string.local_history)),
