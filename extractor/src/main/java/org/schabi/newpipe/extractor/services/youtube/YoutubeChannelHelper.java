...
public final class YoutubeChannelHelper {
     ...
     */
    @NotNull
    public static String resolveChannelId(@NotNull final String idOrPath)
    ...
    public static final class ChannelResponseData {
        ...
        private ChannelResponseData(@NotNull final JsonObject jsonResponse,
     ...
     */
    @NotNull
    public static ChannelResponseData getChannelResponse(@NotNull final String channelId,
                                                         @NotNull final String parameters,
                                                         @NotNull final Localization localization,
                                                         @NotNull final ContentCountry country)
            throws ExtractionException, IOException {
        String id = channelId;
     ...
     */
    private static void checkIfChannelResponseIsValid(@NotNull final JsonObject jsonResponse)
    ...
    public static final class ChannelHeader {
        ...
        private ChannelHeader(@NotNull final JsonObject json, final HeaderType headerType) {
            this.json = json;
    ...
    public static Optional<ChannelHeader> getChannelHeader(
            @NotNull final JsonObject channelResponse) {
     ...
     */
    public static boolean isChannelVerified(@NotNull final ChannelHeader channelHeader) {
    ...
    public static String getChannelId(
            ...
            @NotNull final Optional<ChannelHeader> header,
            @NotNull final JsonObject jsonResponse,
    ...
    public static String getChannelName(@SuppressWarnings("OptionalUsedAsFieldOrParameterType")
                                        @NotNull final Optional<ChannelHeader> channelHeader,
                                        @NotNull final JsonObject jsonResponse,
    ...
    @Nullable
    public static JsonObject getChannelAgeGateRenderer(@NotNull final JsonObject jsonResponse) {
