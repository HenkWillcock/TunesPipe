...
public final class VideoStream extends Stream {
    ...
    public static final class Builder {
         ...
         * @return this {@link Builder} instance
         */
        public Builder setDeliveryMethod(@NotNull final DeliveryMethod deliveryMethod) {
         ...
         * @return this {@link Builder} instance
         */
        public Builder setResolution(@NotNull final String resolution) {
    ...
    private VideoStream(@NotNull final String id,
                        @NotNull final String content,
                        final boolean isUrl,
                        @Nullable final MediaFormat format,
                        @NotNull final DeliveryMethod deliveryMethod,
