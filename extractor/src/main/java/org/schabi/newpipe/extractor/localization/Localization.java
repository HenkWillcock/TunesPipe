...
public class Localization implements Serializable {
    ...
    public Localization(@NotNull final String languageCode, @Nullable final String countryCode) {
        this.languageCode = languageCode;
        this.countryCode = countryCode;
    }

    public Localization(@NotNull final String languageCode) {
    ...
    public static Localization fromLocale(@NotNull final Locale locale) {
     ...
     */
    public static Locale getLocaleFromThreeLetterCode(@NotNull final String code)
    ...
    public static String getEnglishName(@NotNull final String code) {
        switch (code) {
            case "fr":
                return "French";
            case "zh-Hans":
