...
public class SoundcloudStreamExtractor extends StreamExtractor {
    ...
    private static boolean checkMp3ProgressivePresence(@NotNull final JsonArray transcodings) {
    ...
    @Nullable
    private String getDownloadUrl(@NotNull final String trackId)
            throws IOException, ExtractionException {
    ...
    private void extractAudioStreams(@NotNull final JsonArray transcodings,
