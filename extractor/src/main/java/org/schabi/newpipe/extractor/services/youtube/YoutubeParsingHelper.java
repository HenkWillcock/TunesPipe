...
import org.schabi.newpipe.extractor.nanojson.JsonBuilder;
...
import org.schabi.newpipe.extractor.nanojson.JsonWriter;
...
YoutubeParsingHelper {
    ...
    public static boolean isYoutubeURL(@NotNull final URL url) {
        return YOUTUBE_URLS.contains(url.getHost().toLowerCase(Locale.ROOT));
    }

    public static boolean isYoutubeServiceURL(@NotNull final URL url) {
        final String host = url.getHost();
        return host.equalsIgnoreCase("www.youtube-nocookie.com")
                || host.equalsIgnoreCase("youtu.be");
    }

    public static boolean isHooktubeURL(@NotNull final URL url) {
        final String host = url.getHost();
        return host.equalsIgnoreCase("hooktube.com");
    }

    public static boolean isInvidiousURL(@NotNull final URL url) {
        return INVIDIOUS_URLS.contains(url.getHost().toLowerCase(Locale.ROOT));
    }

    public static boolean isY2ubeURL(@NotNull final URL url) {
     ...
     */
    public static int parseDurationString(@NotNull final String input)
    ...
    @NotNull
    public static String getFeedUrlFrom(@NotNull final String channelIdOrUser) {
     ...
     */
    public static boolean isYoutubeMixId(@NotNull final String playlistId) {
     ...
     */
    public static boolean isYoutubeMyMixId(@NotNull final String playlistId) {
     ...
     */
    public static boolean isYoutubeMusicMixId(@NotNull final String playlistId) {
     ...
     */
    public static boolean isYoutubeChannelMixId(@NotNull final String playlistId) {
     ...
     */
    public static boolean isYoutubeGenreMixId(@NotNull final String playlistId) {
    ...
    private static String getClientVersionFromServiceTrackingParam(
            @NotNull final Stream<JsonObject> serviceTrackingParamsStream,
            @NotNull final String serviceName,
            @NotNull final String clientVersionKey) {
    ...
    @Nullable
    public static String getUrlFromNavigationEndpoint(@NotNull final JsonObject navigationEndpoint)
            throws ParsingException {
    ...
    @Nullable
    public static String getTextAtKey(@NotNull final JsonObject jsonObject, final String theKey)
            throws ParsingException {
    ...
    public static String fixThumbnailUrl(@NotNull final String thumbnailUrl) {
    ...
    public static List<Image> getImagesFromThumbnailsArray(
            @NotNull final JsonArray thumbnails) {
    ...
    @NotNull
    public static String getValidJsonResponseBody(@NotNull final Response response)
    ...
    public static JsonObject getJsonPostResponse(@NotNull final String endpoint,
                                                 final byte[] body,
                                                 @NotNull final Localization localization)
            throws IOException, ExtractionException {
    ...
    public static JsonObject getJsonPostResponse(@NotNull final String endpoint,
                                                 @NotNull final List<String> queryParameters,
                                                 final byte[] body,
                                                 @NotNull final Localization localization)
            throws IOException, ExtractionException {
        final Map<String, List<String>> headers = getYouTubeHeaders();
    ...
    private static JsonObject getMobilePostResponse(
            ...
            @NotNull final String innerTubeApiKey,
            @Nullable final String endPartOfUrlRequest) throws IOException, ExtractionException {
        final Map<String, List<String>> headers = new HashMap<>();
        headers.put("Content-Type", singletonList("application/json"));
    ...
    public static JsonBuilder<JsonObject> prepareDesktopJsonBuilder(
            @NotNull final Localization localization,
            @NotNull final ContentCountry contentCountry) throws IOException, ExtractionException {
        // @formatter:off
    ...
    public static JsonBuilder<JsonObject> prepareAndroidMobileJsonBuilder(
            @NotNull final Localization localization,
            @NotNull final ContentCountry contentCountry,
            @NotNull final String visitorData) {
        // @formatter:off
        return JsonObject.builder()
                .object("context")
                .object("client")
    ...
    public static Response getWebPlayerResponseSync(@NotNull final String videoId)
            throws IOException, ExtractionException {
    ...
    public static byte[] createTvHtml5EmbedPlayerBody(
            ...
            @NotNull final ContentCountry contentCountry,
            @NotNull final String videoId,
            @NotNull final Integer sts,
            @NotNull final String contentPlaybackNonce) {
        // @formatter:off
     ...
     */
    public static void addYoutubeHeaders(@NotNull final Map<String, List<String>> headers)
            throws IOException, ExtractionException {
    ...
    public static void addLoggedInHeaders(@NotNull final Map<String, List<String>> headers) throws ExtractionException {
     ...
     */
    public static Map<String, List<String>> getOriginReferrerHeaders(@NotNull final String url) {
     ...
     */
    static Map<String, List<String>> getClientHeaders(@NotNull final String name,
     ...
     * @param headers the headers which should be completed
     */
    public static void addCookieHeader(@NotNull final Map<String, List<String>> headers) {
     ...
     */
    public static void defaultAlertsCheck(@NotNull final JsonObject initialData)
            throws ParsingException {
    ...
    @NotNull
    public static List<MetaInfo> getMetaInfo(@NotNull final JsonArray contents)
            throws ParsingException {
    ...
    @NotNull
    private static MetaInfo getInfoPanelContent(@NotNull final JsonObject infoPanelContentRenderer)
            throws ParsingException {
    ...
    private static MetaInfo getClarificationRendererContent(
            @NotNull final JsonObject clarificationRenderer) throws ParsingException {
        final MetaInfo metaInfo = new MetaInfo();
    ...
    public static boolean hasArtistOrVerifiedIconBadgeAttachment(
            @NotNull final JsonArray attachmentRuns) {
     ...
     */
    public static boolean isWebStreamingUrl(@NotNull final String url) {
     ...
     */
    public static boolean isTvHtml5SimplyEmbeddedPlayerStreamingUrl(@NotNull final String url) {
     ...
     */
    public static boolean isAndroidStreamingUrl(@NotNull final String url) {
     ...
     */
    public static boolean isIosStreamingUrl(@NotNull final String url) {
    ...
    public static String getVisitorDataFromInnertube(
            @NotNull final InnertubeClientRequestInfo innertubeClientRequestInfo,
            @NotNull final Localization localization,
            @NotNull final ContentCountry contentCountry,
            @NotNull final Map<String, List<String>> httpHeaders,
            @NotNull final String innertubeDomainAndVersionEndpoint,
