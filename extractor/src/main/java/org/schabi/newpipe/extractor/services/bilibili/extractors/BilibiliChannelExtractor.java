...
public class BilibiliChannelExtractor extends ChannelExtractor {
    ...
    public interface UserVideoImpl {
        ...
        boolean getInitialPage(
                @NotNull StreamInfoItemsCollector collector,
                @NotNull ChannelExtractor extractor
        ) throws IOException, ExtractionException;
    ...
    public static class ClientUserVideoImpl implements UserVideoImpl {
        ...
        @Override
        public void onFetchPage(@NotNull Downloader downloader, String id, String url) throws IOException, ExtractionException {
