...
public class YoutubeCommentsExtractor extends CommentsExtractor {
    ...
    @NotNull
    private JsonObject getMutationPayloadFromEntityKey(@NotNull final JsonArray mutations,
                                                       @NotNull final String commentKey)
    ...
    @Nullable
    private Page getNextPage(@NotNull final JsonObject jsonObject, JSONObject jsonObjectSafe) throws ExtractionException {
    ...
    private void collectCommentsFrom(@NotNull final CommentsInfoItemsCollector collector,
    ...
    private void collectCommentItem(@NotNull final JsonArray mutations,
                                    @NotNull final JsonObject content,
                                    @NotNull final CommentsInfoItemsCollector collector,
                                    @NotNull final String videoUrl,
                                    @NotNull final TimeAgoParser timeAgoParser)
            throws ParsingException {
