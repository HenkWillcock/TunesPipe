...
public final class YoutubeOtfDashManifestCreator {
    ...
    public static String fromOtfStreamingUrl(
            @NotNull final String otfBaseStreamingUrl,
    ...
    private static void generateSegmentElementsForOtfStreams(
            @NotNull final String[] segmentDurations,
            @NotNull final Document doc) throws CreationException {
        try {
     ...
     */
    private static long getStreamDuration(@NotNull final String[] segmentDuration)
