...
public class YoutubeChannelExtractor extends ChannelExtractor {
    ...
    @Override
    public void onFetchPage(@NotNull final Downloader downloader) throws IOException, ExtractionException {
    ...
    private long getSubscriberCountFromPageChannelHeader(@NotNull final JsonObject headerJson)
...
,
     ...
     */
    private JsonObject collectStreamsFrom(@NotNull final StreamInfoItemsCollector collector,
                                          @NotNull final JsonArray videos,
                                          @NotNull final JsonArray tempVideos,
                                          @NotNull final List<String> channelIds)
    {
        collector.reset();
