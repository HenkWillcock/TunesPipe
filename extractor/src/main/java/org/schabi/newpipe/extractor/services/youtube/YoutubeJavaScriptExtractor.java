...
final class YoutubeJavaScriptExtractor {
     ...
     */
    @NotNull
    static String extractJavaScriptPlayerCode(@NotNull final String videoId)
    ...
    @NotNull
    static String extractJavaScriptUrlWithEmbedWatchPage(@NotNull final String videoId)
            throws ParsingException {
    ...
    @NotNull
    private static String cleanJavaScriptUrl(@NotNull final String javaScriptPlayerUrl) {
    ...
    @NotNull
    private static String downloadJavaScriptCode(@NotNull final String javaScriptPlayerUrl)
            throws ParsingException {
        try {
