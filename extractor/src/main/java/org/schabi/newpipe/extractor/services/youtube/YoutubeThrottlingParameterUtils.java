...
final class YoutubeThrottlingParameterUtils {
     ...
     */
    @NotNull
    static String getDeobfuscationFunctionName(@NotNull final String javaScriptPlayerCode)
     ...
     */
    @NotNull
    static String getDeobfuscationFunction(@NotNull final String javaScriptPlayerCode,
     ...
     */
    @NotNull
    private static String fixupFunction(@NotNull final String function, final Result varData)
     ...
     */
    @Nullable
    static String getThrottlingParameterFromStreamingUrl(@NotNull final String streamingUrl) {
        try {
    ...
    @NotNull
    private static String parseFunctionWithLexer(@NotNull final String javaScriptPlayerCode,
                                                 @NotNull final String functionName)
            throws ParsingException {
    ...
    @NotNull
    private static String parseFunctionWithRegex(@NotNull final String javaScriptPlayerCode,
                                                 @NotNull final String functionName)
            throws Parser.RegexException {
    ...
    @NotNull
    private static String validateFunction(@NotNull final String function) {
