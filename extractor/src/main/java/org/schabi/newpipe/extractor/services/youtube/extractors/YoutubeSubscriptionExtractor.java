...
public class YoutubeSubscriptionExtractor extends SubscriptionExtractor {
    ...
    @Override
    public List<SubscriptionItem> fromInputStream(@NotNull final InputStream contentInputStream)
    ...
    public List<SubscriptionItem> fromJsonInputStream(@NotNull final InputStream contentInputStream)
            throws ExtractionException {
    ...
    public List<SubscriptionItem> fromZipInputStream(@NotNull final InputStream contentInputStream)
            throws ExtractionException {
    ...
    public List<SubscriptionItem> fromCsvInputStream(@NotNull final InputStream contentInputStream)
            throws ExtractionException {
