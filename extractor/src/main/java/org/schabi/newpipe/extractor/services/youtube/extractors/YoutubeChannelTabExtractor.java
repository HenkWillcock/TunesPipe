...
public class YoutubeChannelTabExtractor extends ChannelTabExtractor {
    ...
    @Override
    public void onFetchPage(@NotNull final Downloader downloader) throws IOException,
            ExtractionException {
    ...
    private void commitPlaylistLockup(@NotNull final MultiInfoItemsCollector collector,
                                      @NotNull final JsonObject playlistLockupViewModel,
//                                      @NotNull final VerifiedStatus channelVerifiedStatus,
...
//                    }
    ...
    @Nullable
    private JsonObject collectItemsFrom(@NotNull final MultiInfoItemsCollector collector,
                                        @NotNull final JsonArray items,
                                        @NotNull final List<String> channelIds) throws ParsingException {
    ...
    @Nullable
    private JsonObject collectItem(@NotNull final MultiInfoItemsCollector collector,
                                   @NotNull final JsonObject item,
                                   @NotNull final List<String> channelIds) throws ParsingException {
