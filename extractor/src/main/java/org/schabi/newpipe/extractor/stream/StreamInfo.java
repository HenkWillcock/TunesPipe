...
public class StreamInfo extends Info {
    ...
    public static StreamInfo getInfo(@NotNull final StreamingService service,
                                     final String url) throws IOException, ExtractionException {
        return getInfo(service.getStreamExtractor(url));
    }

    public static StreamInfo getInfo(@NotNull final StreamExtractor extractor)
    ...
    @NotNull
    private static StreamInfo extractImportantData(@NotNull final StreamExtractor extractor)
    ...
    public void setThumbnails(@NotNull final List<Image> thumbnails) {
    ...
    public void setUploaderAvatars(@NotNull final List<Image> uploaderAvatars) {
    ...
    public void setSubChannelAvatars(@NotNull final List<Image> subChannelAvatars) {
