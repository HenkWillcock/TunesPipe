...
public final class YoutubeProgressiveDashManifestCreator {
    ...
    public static String fromProgressiveStreamingUrl(
            @NotNull final String progressiveStreamingBaseUrl,
     ...
     */
    private static void generateBaseUrlElement(@NotNull final Document doc,
     ...
     */
    private static void generateSegmentBaseElement(@NotNull final Document doc,
                                                   @NotNull final ItagItem itagItem)
            throws CreationException {
        try {
            final Element representationElement = (Element) doc.getElementsByTagName(
     ...
     * @param itagItem the {@link ItagItem} to use, which must not be null
     */
    private static void generateInitializationElement(@NotNull final Document doc,
                                                      @NotNull final ItagItem itagItem)
            throws CreationException {
        try {
