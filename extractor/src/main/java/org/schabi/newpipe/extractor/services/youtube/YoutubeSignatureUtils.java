...
//            Pattern.compile("\\bm=([a-zA-Z0-9$]{2,})\\(decodeURIComponent\\(h\\.s\\)\\)"),
     ...
     */
    @NotNull
    static String getSignatureTimestamp(@NotNull final String javaScriptPlayerCode)
     ...
     */
    @NotNull
    static String getDeobfuscationCode(@NotNull final String javaScriptPlayerCode)
            throws ParsingException {
        try {
    ...
    @NotNull
    private static String getDeobfuscationFunctionName(@NotNull final String javaScriptPlayerCode)
            throws ParsingException {
        try {
    ...
    private static String getDeobfuscateFunctionWithLexer(
            @NotNull final String javaScriptPlayerCode,
            @NotNull final String deobfuscationFunctionName) throws ParsingException {
    ...
    @NotNull
    private static String getHelperObject(@NotNull final String javaScriptPlayerCode,
                                          @NotNull final String helperObjectName)
            throws ParsingException {
