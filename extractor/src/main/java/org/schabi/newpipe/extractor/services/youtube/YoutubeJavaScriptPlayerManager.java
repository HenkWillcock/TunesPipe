...
public final class YoutubeJavaScriptPlayerManager {
     ...
     */
    @NotNull
    public static Integer getSignatureTimestamp(@NotNull final String videoId)
     ...
     */
    @NotNull
    public static String deobfuscateSignature(@NotNull final String videoId,
                                              @NotNull final String obfuscatedSignature)
            throws ParsingException {
    ...
    public static String getUrlWithThrottlingParameterDeobfuscated(
            ...
            @NotNull final String streamingUrl) throws ParsingException {
     ...
     */
    private static void extractJavaScriptCodeIfNeeded(@NotNull final String videoId)
            throws ParsingException {
