...
import org.schabi.newpipe.extractor.nanojson.*;
...
//        }
    ...
    private int getDurationFromFirstAdaptiveFormat(@NotNull final List<JsonObject> streamingDatas)
    ...
    @NotNull
    private static String getManifestUrl(@NotNull final String manifestType,
                                         @NotNull final List<JsonObject> streamingDataObjects) {
    ...
    public static JsonObject checkPlayabilityStatus(@NotNull JsonObject playabilityStatus, String videoId)
            throws ParsingException {
     ...
     * object.
     */
    private CancellableCall fetchAndroidMobileJsonPlayer(@NotNull final ContentCountry contentCountry,
     ...
     * object.
     */
    private CancellableCall fetchIosMobileJsonPlayer(@NotNull final ContentCountry contentCountry,
                                                     @NotNull final Localization localization,
                                                     @NotNull final String videoId)
            throws IOException, ExtractionException {
     ...
     */
    private CancellableCall fetchWebJsonPlayer(@NotNull final ContentCountry contentCountry,
                                             @NotNull final Localization localization,
                                             @NotNull final String videoId)
            throws IOException, ExtractionException {
    ...
    private CancellableCall fetchTvHtml5EmbedJsonPlayer(@NotNull final ContentCountry contentCountry,
                                                        @NotNull final Localization localization,
                                                        @NotNull final String videoId)
            throws IOException, ExtractionException {
    ...
    public static boolean isPlayerResponseNotValid(
            @NotNull final JsonObject additionalPlayerResponse,
            @NotNull final String videoId) {
    ...
    @NotNull
    private JsonObject getVideoInfoRenderer(@NotNull final String videoRendererName) {
    ...
    private java.util.stream.Stream<ItagInfo> getStreamsFromStreamingDataKey(
            ...
            final String streamingDataKey,
            @NotNull final ItagItem.ItagType itagTypeWanted,
    ...
    private ItagInfo buildAndAddItagInfoToList(
            @NotNull final String videoId,
            @NotNull final JsonObject formatData,
            @NotNull final ItagItem itagItem,
            @NotNull final ItagItem.ItagType itagType,
            @NotNull final String contentPlaybackNonce) throws IOException, ExtractionException {
        String streamUrl;
