...
public class ChannelInfo extends ListInfo<StreamInfoItem> {
    ...
    public void setAvatars(@NotNull final List<Image> avatars) {
    ...
    public void setBanners(@NotNull final List<Image> banners) {
    ...
    public void setTabs(@NotNull final List<ListLinkHandler> tabs) {
        this.tabs = tabs;
    }
    ...
    public void setTags(@NotNull final List<String> tags) {
        this.tags = tags;
    }
}
