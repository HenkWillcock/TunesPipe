...
public final class YoutubeDescriptionHelper {
    ...
    static final class Run {
        @NotNull final String open;
        @NotNull final String close;
        final int pos;
        ...
        public boolean sameOpen(@NotNull final Run other) {
    ...
    static String runsToHtml(
            @NotNull final List<Run> openers,
            @NotNull final List<Run> closers,
    ...
    private static void addAllCommandRuns(
            @NotNull final JsonObject attributedDescription,
            @NotNull final List<Run> openers,
            @NotNull final List<Run> closers
    ) {
